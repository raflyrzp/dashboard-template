                ...
                <div class="border-top">
                    ...
                    <div class="row mb-5">
                        <div class="col-xl-8">
                            <ul class="list-unstyled">
                                <li class="text-muted">
                                    Nama : {{ $topup->wallet->user->nama }}
                                </li>
                                <li class="text-muted">{{ $topup->created_at }}</li>
                                <li class="text-muted">{{ $topup->kode_unik }}</li>
                                </li>
                    ...
                    <div class="row my-2 mx-1 justify-content-center">
                        ...
                        {{-- <div class="ms-3 col-8">
                            <p class="fw-bold mb-1">Kode Unik <span class="float-right">{{ $topup->created_at }}</span>
                            </p>
                        </div> --}}
                    </div>
                    <hr class="mt-5" />
